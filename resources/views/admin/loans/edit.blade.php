                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('loan_number') ? 'is-invalid' : '' }}" type="number" name="loan_number" id="loan_number" value="{{ old('loan_number', $loan->loan_number) }}" step="1" readonly>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2 {{ $errors->has('product') ? 'is-invalid' : '' }}" name="product_id" id="product_id">
                                                    @foreach ($products as $id => $product)
                                                        <option value="{{ $id }}" {{ (old('product_id') ? old('product_id') : $loan->product->id ?? '') == $id ? 'selected' : '' }}>
                                                            {{ $product }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('customer') ? 'is-invalid' : '' }}" type="text" name="customer" id="customer" value="{{ old('customer', $loan->customer) }}" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('lender') ? 'is-invalid' : '' }}" type="text" name="lender" id="lender" value="{{ old('lender', $loan->lender) }}" onkeydown="limit(this);" onkeyup="limit(this);">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('processor') ? 'is-invalid' : '' }}" type="text" name="processor" id="processor" value="{{ old('processor', $loan->processor) }}" onkeydown="limit(this);" onkeyup="limit(this);" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $loan->address) }}">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control datepicker {{ $errors->has('closing_date') ? 'is-invalid' : '' }}" type="text" name="closing_date" id="closing_date" value="{{ old('closing_date', $loan->closing_date) }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control timepicker {{ $errors->has('closing_time') ? 'is-invalid' : '' }}" type="text" name="closing_time" id="closing_time" value="{{ old('closing_time', $loan->closing_time) }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('closing_location') ? 'is-invalid' : '' }}" type="text" name="closing_location" id="closing_location" value="{{ old('closing_location', $loan->closing_location) }}">
                                ...
                                <div class="col">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('title_company') ? 'is-invalid' : '' }}" type="text" name="title_company" id="title_company" value="{{ old('title_company', $loan->title_company) }}">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check {{ $errors->has('appraisal_ordered') ? 'is-invalid' : '' }}">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="appraisal_ordered" id="appraisal_ordered" value="1" {{ $loan->appraisal_ordered || old('appraisal_ordered', 0) === 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                <div class="form-check {{ $errors->has('flood_ordered') ? 'is-invalid' : '' }}">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="flood_ordered" id="flood_ordered" value="1" {{ $loan->flood_ordered || old('flood_ordered', 0) === 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-group">
                                                <div class="form-check {{ $errors->has('title_ordered') ? 'is-invalid' : '' }}">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="title_ordered" id="title_ordered" value="1" {{ $loan->title_ordered || old('title_ordered', 0) === 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control {{ $errors->has('interest_rate') ? 'is-invalid' : '' }}" type="text" name="interest_rate" id="interest_rate" value="{{ old('interest_rate', $loan->interest_rate) }}">
                                        ...
                                        <div class="col d-flex align-items-center">
                                            <div class="form-group">
                                                <div class="form-check {{ $errors->has('interest_rate_locked') ? 'is-invalid' : '' }}">
                                                    ...
                                                    <input class="form-check-input" type="checkbox" name="interest_rate_locked" id="interest_rate_locked" value="1" {{ $loan->interest_rate_locked || old('interest_rate_locked', 0) === 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="col">
                                            <div id="form-group-interest-rate-expiration" class="form-group {{ $loan->interest_rate_locked || old('interest_rate_locked', 0) === 1 ? 'visible' : '' }}">
                                                <label for="interest_rate_expiration">{{ trans('cruds.loan.fields.interest_rate_expiration') }}</label>
                                                <input class="form-control datepicker {{ $errors->has('interest_rate_expiration') ? 'is-invalid' : '' }}" type="text" name="interest_rate_expiration" id="interest_rate_expiration" value="{{ old('interest_rate_expiration', $loan->interest_rate_expiration) }}" onchange="interestRateLockValueChanged()">
                                    ...
                                    <div class="form-group">
                                        <div class="form-check {{ $errors->has('approval_required') ? 'is-invalid' : '' }}">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="approval_required" id="approval_required" value="1" {{ $loan->approval_required || old('approval_required', 0) === 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <div class="form-check {{ $errors->has('approval_documents_signed') ? 'is-invalid' : '' }}">
                                            ...
                                            <input class="form-check-input" type="checkbox" name="approval_documents_signed" id="approval_documents_signed" value="1" {{ $loan->approval_documents_signed || old('approval_documents_signed', 0) === 1 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('contact_info') ? 'is-invalid' : '' }}" name="contact_info" id="contact_info">{{ old('contact_info', $loan->contact_info) }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="6" class="form-control {{ $errors->has('notes') ? 'is-invalid' : '' }}" name="notes" id="notes">{{ old('notes', $loan->notes) }}</textarea>
                                        @if ($errors->has('notes'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('notes') }}
                                            </div>
